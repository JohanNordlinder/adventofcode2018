...
namespace AdventOfCode2018
{
    ...
    public class D17P2
    {
        ...
        public void TestRun()
        {
            ...
            Assert.AreEqual(29, new Program().RunChallenge(input));
        }
        ...
        public class Program
        {
            ...
            private void MarkAsHasWater(Square square)
            {
                if (!square.HasWater)
                {
                    square.HasWater = true;
                    if (square.DoesCount)
                    {
                        NumerHasWater++;
                    }
